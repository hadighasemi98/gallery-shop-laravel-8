...
@section('content')
    ...
    <div class="container">
        <div class="bread-crumb flex-w p-t-30">
            <a href="{{ route('home.page') }}" class="mtext-106 cl8 hov-cl1 trans-04">
                خانه
                        ...
                        <div class="p-t-33">
                            ...
                            <div class="flex-w flex-r-m p-b-10">
                                <div class="flex-w flex-m respon6-next">
                                    <a href="{{ route('home.addToBasket' , $product->id ) }}" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail">
                                        افزودن به سبد خرید
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
                        ...
                        <div class="block2">
                            ...
                            <a href="{{ route('home.product.show' , $product->id ) }}">
                                <img src="/{{ $similarProduct->demo_url }}" alt="IMG-PRODUCT" height='250px' >
                            </a>
